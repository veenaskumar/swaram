    ...
    return (
        <Zoom>
            <div class=" flex flex-col items-center justify-center ">
                <div>
                    <h1 className='text-[red] text-center font-semibold'>Our Thoughts</h1>
                </div><br /><br />
                <div class="row gap-[7rem]  justify-around items-center">
                    <div class="rounded-xl bg-white p-6 text-center shadow-xl w-[500px]">
                        <div
                            class="mx-auto flex h-[100px] w-[100px] -translate-y-12 transform items-center justify-center rounded-full bg-teal-400 shadow-lg shadow-teal-500/40">
